...
void RendererCanvasRenderGLES3::_update_transform_2d_to_mat4(const Transform2D &p_transform, float *p_mat4) {
...
void RendererCanvasRenderGLES3::_update_transform_2d_to_mat2x4(const Transform2D &p_transform, float *p_mat2x4) {
...
void RendererCanvasRenderGLES3::_update_transform_2d_to_mat2x3(const Transform2D &p_transform, float *p_mat2x3) {
...
void RendererCanvasRenderGLES3::_update_transform_to_mat4(const Transform3D &p_transform, float *p_mat4) {
...
void RendererCanvasRenderGLES3::canvas_render_items(RID p_to_render_target, Item *p_item_list, const Color &p_modulate, Light *p_light_list, Light *p_directional_light_list, const Transform2D &p_canvas_transform, RS::CanvasItemTextureFilter p_default_filter, RS::CanvasItemTextureRepeat p_default_repeat, bool p_snap_2d_vertices_to_pixel, bool &r_sdf_used) {
...
void RendererCanvasRenderGLES3::_render_items(RID p_to_render_target, int p_item_count, const Transform2D &p_canvas_transform_inverse, Light *p_lights, uint32_t &r_last_index, bool &r_sdf_used, bool p_to_backbuffer) {
	GLES3::MaterialStorage *material_storage = GLES3::MaterialStorage::get_singleton();
...
void RendererCanvasRenderGLES3::_record_item_commands(const Item *p_item, RID p_render_target, const Transform2D &p_canvas_transform_inverse, Item *&current_clip, GLES3::CanvasShaderData::BlendMode p_blend_mode, Light *p_lights, uint32_t &r_index, bool &r_batch_broken, bool &r_sdf_used) {
...
void RendererCanvasRenderGLES3::_render_batch(Light *p_lights, uint32_t p_index) {
...
void RendererCanvasRenderGLES3::_add_to_batch(uint32_t &r_index, bool &r_batch_broken) {
...
void RendererCanvasRenderGLES3::_new_batch(bool &r_batch_broken, uint32_t &r_index) {
...
void RendererCanvasRenderGLES3::_enable_attributes(uint32_t p_start, bool p_primitive, uint32_t p_rate) {
...
RID RendererCanvasRenderGLES3::light_create() {
	CanvasLight canvas_light;
	return canvas_light_owner.make_rid(canvas_light);
}

void RendererCanvasRenderGLES3::light_set_texture(RID p_rid, RID p_texture) {
	GLES3::TextureStorage *texture_storage = GLES3::TextureStorage::get_singleton();
...
void RendererCanvasRenderGLES3::light_set_use_shadow(RID p_rid, bool p_enable) {
	CanvasLight *cl = canvas_light_owner.get_or_null(p_rid);
	ERR_FAIL_COND(!cl);
...
void RendererCanvasRenderGLES3::light_update_shadow(RID p_rid, int p_shadow_index, const Transform2D &p_light_xform, int p_light_mask, float p_near, float p_far, LightOccluderInstance *p_occluders) {
...
void RendererCanvasRenderGLES3::light_update_directional_shadow(RID p_rid, int p_shadow_index, const Transform2D &p_light_xform, int p_light_mask, float p_cull_distance, const Rect2 &p_clip_rect, LightOccluderInstance *p_occluders) {
	GLES3::Config *config = GLES3::Config::get_singleton();
...
void RendererCanvasRenderGLES3::_update_shadow_atlas() {
	GLES3::Config *config = GLES3::Config::get_singleton();
...
void RendererCanvasRenderGLES3::render_sdf(RID p_render_target, LightOccluderInstance *p_occluders) {
	GLES3::TextureStorage *texture_storage = GLES3::TextureStorage::get_singleton();
...
RID RendererCanvasRenderGLES3::occluder_polygon_create() {
	OccluderPolygon occluder;

	return occluder_polygon_owner.make_rid(occluder);
}

void RendererCanvasRenderGLES3::occluder_polygon_set_shape(RID p_occluder, const Vector<Vector2> &p_points, bool p_closed) {
...
void RendererCanvasRenderGLES3::occluder_polygon_set_cull_mode(RID p_occluder, RS::CanvasOccluderPolygonCullMode p_mode) {
	OccluderPolygon *oc = occluder_polygon_owner.get_or_null(p_occluder);
	ERR_FAIL_COND(!oc);
	oc->cull_mode = p_mode;
}

void RendererCanvasRenderGLES3::set_shadow_texture_size(int p_size) {
	GLES3::Config *config = GLES3::Config::get_singleton();
...
bool RendererCanvasRenderGLES3::free(RID p_rid) {
...
void RendererCanvasRenderGLES3::update() {
}

void RendererCanvasRenderGLES3::canvas_begin(RID p_to_render_target, bool p_to_backbuffer) {
	GLES3::TextureStorage *texture_storage = GLES3::TextureStorage::get_singleton();
	GLES3::Config *config = GLES3::Config::get_singleton();
...
void RendererCanvasRenderGLES3::_bind_canvas_texture(RID p_texture, RS::CanvasItemTextureFilter p_base_filter, RS::CanvasItemTextureRepeat p_base_repeat) {
	GLES3::TextureStorage *texture_storage = GLES3::TextureStorage::get_singleton();
	GLES3::Config *config = GLES3::Config::get_singleton();
...
void RendererCanvasRenderGLES3::_prepare_canvas_texture(RID p_texture, RS::CanvasItemTextureFilter p_base_filter, RS::CanvasItemTextureRepeat p_base_repeat, uint32_t &r_index, Size2 &r_texpixel_size) {
	GLES3::TextureStorage *texture_storage = GLES3::TextureStorage::get_singleton();
...
void RendererCanvasRenderGLES3::reset_canvas() {
	glDisable(GL_CULL_FACE);
	glDisable(GL_DEPTH_TEST);
	glDisable(GL_SCISSOR_TEST);
	glEnable(GL_BLEND);
...
void RendererCanvasRenderGLES3::draw_lens_distortion_rect(const Rect2 &p_rect, float p_k1, float p_k2, const Vector2 &p_eye_center, float p_oversample) {
}

RendererCanvasRender::PolygonID RendererCanvasRenderGLES3::request_polygon(const Vector<int> &p_indices, const Vector<Point2> &p_points, const Vector<Color> &p_colors, const Vector<Point2> &p_uvs, const Vector<int> &p_bones, const Vector<float> &p_weights) {
...
void RendererCanvasRenderGLES3::free_polygon(PolygonID p_polygon) {
...
void RendererCanvasRenderGLES3::_allocate_instance_data_buffer() {
...
void RendererCanvasRenderGLES3::set_time(double p_time) {
	state.time = p_time;
}

RendererCanvasRenderGLES3 *RendererCanvasRenderGLES3::singleton = nullptr;

RendererCanvasRenderGLES3 *RendererCanvasRenderGLES3::get_singleton() {
	return singleton;
}

RendererCanvasRenderGLES3::RendererCanvasRenderGLES3() {
	singleton = this;
	GLES3::TextureStorage *texture_storage = GLES3::TextureStorage::get_singleton();
	GLES3::MaterialStorage *material_storage = GLES3::MaterialStorage::get_singleton();
	GLES3::Config *config = GLES3::Config::get_singleton();
