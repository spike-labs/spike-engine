...
class RendererCanvasRenderGLES3;

class RendererSceneRenderGLES3 : public RendererSceneRender {
private:
	static RendererSceneRenderGLES3 *singleton;
...
public:
	static RendererSceneRenderGLES3 *get_singleton() { return singleton; }
