...
RS::InstanceType Utilities::get_base_type(RID p_rid) const {
	if (OPENGL3::MeshStorage::get_singleton()->owns_mesh(p_rid)) {
		return RS::INSTANCE_MESH;
	} else if (OPENGL3::MeshStorage::get_singleton()->owns_multimesh(p_rid)) {
	...
	} else if (OPENGL3::ParticlesStorage::get_singleton()->owns_particles(p_rid)) {
		return RS::INSTANCE_PARTICLES;
	} else if (OPENGL3::ParticlesStorage::get_singleton()->owns_particles_collision(p_rid)) {
...
bool Utilities::free(RID p_rid) {
	if (GLES3::TextureStorage::get_singleton()->owns_render_target(p_rid)) {
		...
		return true;
	} else if (OPENGL3::MeshStorage::get_singleton()->owns_mesh(p_rid)) {
		OPENGL3::MeshStorage::get_singleton()->mesh_free(p_rid);
		return true;
	} else if (OPENGL3::MeshStorage::get_singleton()->owns_multimesh(p_rid)) {
		OPENGL3::MeshStorage::get_singleton()->multimesh_free(p_rid);
		return true;
	} else if (OPENGL3::MeshStorage::get_singleton()->owns_mesh_instance(p_rid)) {
		OPENGL3::MeshStorage::get_singleton()->mesh_instance_free(p_rid);
		return true;
	} else if (GLES3::LightStorage::get_singleton()->owns_light(p_rid)) {
		...
		OPENGL3::ParticlesStorage::get_singleton()->particles_free(p_rid);
		return true;
	} else if (OPENGL3::ParticlesStorage::get_singleton()->owns_particles_collision(p_rid)) {
		OPENGL3::ParticlesStorage::get_singleton()->particles_collision_free(p_rid);
		return true;
	} else if (OPENGL3::ParticlesStorage::get_singleton()->owns_particles_collision_instance(p_rid)) {
		OPENGL3::ParticlesStorage::get_singleton()->particles_collision_instance_free(p_rid);
		return true;
	} else {
		return false;
	}
...
void Utilities::base_update_dependency(RID p_base, DependencyTracker *p_instance) {
	...
	} else if (OPENGL3::ParticlesStorage::get_singleton()->owns_particles(p_base)) {
		Dependency *dependency = OPENGL3::ParticlesStorage::get_singleton()->particles_get_dependency(p_base);
		p_instance->update_dependency(dependency);
	} else if (OPENGL3::ParticlesStorage::get_singleton()->owns_particles_collision(p_base)) {
		Dependency *dependency = OPENGL3::ParticlesStorage::get_singleton()->particles_collision_get_dependency(p_base);
		p_instance->update_dependency(dependency);
	}
}
...
void Utilities::update_dirty_resources() {
	GLES3::MaterialStorage::get_singleton()->_update_global_shader_uniforms();
	GLES3::MaterialStorage::get_singleton()->_update_queued_materials();
	//MeshStorage::get_singleton()->_update_dirty_skeletons();
	MeshStorage::get_singleton()->_update_dirty_multimeshes();
	GLES3::TextureStorage::get_singleton()->update_texture_atlas();
}
