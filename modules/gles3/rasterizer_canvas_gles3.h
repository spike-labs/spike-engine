...
class RendererSceneRenderGLES3;

class RendererCanvasRenderGLES3 : public RendererCanvasRender {
	static RendererCanvasRenderGLES3 *singleton;
...
public:
	...
	static RendererCanvasRenderGLES3 *get_singleton();
	RendererCanvasRenderGLES3();
	~RendererCanvasRenderGLES3();
};
